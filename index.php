...
<div style="text-decoration:none;height:70px;width:70px;border-radius:15px;font-size:15px;border:2px solid #6e6e6b;text-align:center;display:flex;flex-direction:column;justify-content:center">
<a href=https://www.linkedin.com/in/davedalimocon/ target=_blank style=text-decoration:none>
<span class=icon-social-linkedin style=font-size:1.5rem>
</span>
<small>linkedin</small>
</a>
</div>
<div style="height:70px;width:70px;border-radius:15px;font-size:15px;border:2px solid #6e6e6b;text-align:center;display:flex;flex-direction:column;justify-content:center">
<a href=https://github.com/mrgreenxgreen target=_blank style=text-decoration:none>
<span class=icon-social-github style=font-size:1.5rem>
</span>
<small>github</small>
</a>
</div>
...
<span class=icon-envelope style=font-size:1.5rem>
</span>
<small>email</small>
</a>
</div>
